...
/obj/item/clothing/suit/armor/hos
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 70, "acid" = 90, "wound" = 10)
...
/obj/item/clothing/suit/armor/vest/capcarapace
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 90, "wound" = 10)
	dog_fashion = null
...
/obj/item/clothing/suit/armor/laserproof
	...
	blood_overlay_type = "armor"
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "linelaser" = 80, "energy" = 50, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 100)
...
/obj/item/clothing/suit/armor/vest/infiltrator
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 30, "bomb" = 70, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50)
...
/obj/item/clothing/suit/armor/centcom
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 50, "bomb" = 100, "bio" = 100, "rad" = 100, "fire" = 90, "acid" = 90)
...
/obj/item/clothing/suit/armor/vest/russian
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 15, "bomb" = 10, "bio" = 0, "rad" = 20, "fire" = 20, "acid" = 50, "wound" = 25)
...
/obj/item/clothing/suit/armor/vest/russian_coat
	...
	cold_protection = CHEST|GROIN|LEGS|FEET|ARMS|HANDS
	min_cold_protection_temperature = SPACE_SUIT_MIN_TEMP_PROTECT
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 10, "bomb" = 20, "bio" = 50, "rad" = 20, "fire" = -10, "acid" = 50,  "wound" = 10)
