...
/obj/item/clothing/suit/hooded/explorer
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 20, "bomb" = 50, "bio" = 100, "rad" = 50, "fire" = 50, "acid" = 50)
...
/obj/item/clothing/head/hooded/explorer
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 20, "bomb" = 50, "bio" = 100, "rad" = 50, "fire" = 50, "acid" = 50, "wound" = 10)
	resistance_flags = FIRE_PROOF
...
/obj/item/clothing/suit/space/hostile_environment
	...
	mutantrace_variation = STYLE_DIGITIGRADE|STYLE_SNEK_TAURIC|STYLE_PAW_TAURIC
	slowdown = 0
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 10, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 100)
...
/obj/item/clothing/suit/hooded/explorer/seva
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 45, "bomb" = 35, "bio" = 75, "rad" = 75, "fire" = 100, "acid" = 50)
...
/obj/item/clothing/suit/hooded/explorer/exo
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 40, "bomb" = 40, "bio" = 40, "rad" = 40, "fire" = 35, "acid" = 35)
