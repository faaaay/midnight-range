/obj/item/clothing/head/wizard
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 20, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 100, "acid" = 100, "wound" = 20)
	strip_delay = 50
...
/obj/item/clothing/suit/space/hardsuit/shielded/wizard
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 20, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 100, "acid" = 100)
	slowdown = 0
	resistance_flags = FIRE_PROOF | ACID_PROOF
