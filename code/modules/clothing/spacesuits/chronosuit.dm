/obj/item/clothing/head/helmet/space/chronos
	...
	slowdown = 1
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 60, "bomb" = 30, "bio" = 90, "rad" = 90, "fire" = 100, "acid" = 100, "wound" = 80)
...
/obj/item/clothing/suit/space/chronos
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 60, "bomb" = 30, "bio" = 90, "rad" = 90, "fire" = 100, "acid" = 1000, "wound" = 80)
	resistance_flags = FIRE_PROOF | ACID_PROOF
