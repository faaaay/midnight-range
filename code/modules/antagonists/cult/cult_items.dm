...
/obj/item/clothing/suit/magusred
	...
	item_state = "magusred"
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
	armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 20, "bomb" = 25, "bio" = 10, "rad" = 0, "fire" = 10, "acid" = 10)
...
/obj/item/clothing/head/helmet/space/hardsuit/cult
	...
	armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 15, "bomb" = 30, "bio" = 30, "rad" = 30, "fire" = 40, "acid" = 75)
	light_range = 0
	actions_types = list()
...
/obj/item/clothing/suit/hooded/cultrobes/cult_shield
	...
	item_state = "cult_armor"
	w_class = WEIGHT_CLASS_BULKY
	armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 30, "bomb" = 50, "bio" = 30, "rad" = 30, "fire" = 50, "acid" = 60)
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
...
/obj/item/clothing/head/hooded/cult_hoodie
	...
	desc = "Empowered garb which creates a powerful shield around the user."
	icon_state = "cult_hoodalt"
	armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 30, "bomb" = 50, "bio" = 30, "rad" = 30, "fire" = 50, "acid" = 50)
